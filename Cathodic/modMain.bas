...
Global DÈfinitionPoint As Integer
Global DÈfinitionQuadrilÈ As Integer
Global DÈfinitionMire As Integer
...
Global Const SND_SYNC = &H1      ' Jouer de faÁon synchrone, et ASYNC de faÁon asyncrone
Global Const SND_NODEFAULT = &H2 ' Ne pas utiliser le son par dÈfaut.
Global Const SND_MEMORY = &H4    ' lpszSoundName pointe vers un fichier en mÈmoire.
...
Sub MireDePoints()
    ...
    Dim Largeur…cran As Variant
    Dim Hauteur…cran As Variant
    Dim DÈfinitionPointLargeur As Variant
    Dim DÈfinitionPointHauteur As Variant
    Dim x As Variant
    Dim y As Variant
    Action = True
    frmPanel.MousePointer = 11
    ...
    Largeur…cran = frmCathodic.ScaleWidth
    Hauteur…cran = frmCathodic.ScaleHeight
    frmCathodic.DrawWidth = 2
    Select Case DÈfinitionPoint
        Case 1
            DÈfinitionPointLargeur = Largeur…cran / 16
            DÈfinitionPointHauteur = Hauteur…cran / 12
        Case 2
            DÈfinitionPointLargeur = Largeur…cran / 8
            DÈfinitionPointHauteur = Hauteur…cran / 6
        Case 3
            DÈfinitionPointLargeur = Largeur…cran / 2
            DÈfinitionPointHauteur = Hauteur…cran / 2
    End Select
    frmCathodic.ForeColor = ChargeCouleur()
    For x = 0 To Largeur…cran Step DÈfinitionPointLargeur
        For y = 0 To Hauteur…cran Step DÈfinitionPointHauteur
...
Sub …cranPowerOff()
    ...
    frmCathodic.Cls
    frmCathodic.DrawWidth = 2
    Largeur…cran = frmCathodic.ScaleWidth / 2
    Hauteur…cran = frmCathodic.ScaleHeight / 2
    …tape = Largeur…cran / 10
    For a = Largeur…cran To 1 Step -…tape
        frmCathodic.Circle (Largeur…cran, Hauteur…cran), a, vbWhite
        frmCathodic.Circle (Largeur…cran, Hauteur…cran), a + …tape, vbBlack
    Next a
    frmCathodic.FillStyle = vbFSSolid
    frmCathodic.Circle (Largeur…cran, Hauteur…cran), 2, vbWhite
...
Sub MireQuadrillÈe()
    ...
    Select Case frmPanel.chkActiver
        Case 0
            ...
            Select Case DÈfinitionQuadrilÈ
                Case 1
                    l00CC = l00C4 / 16
                    l00D0 = l00C8 / 12
                Case 2
...
End Sub
Sub PrÈpareOptionSelonSÈlection()
    ...
    Select Case ChoixDeMire
        Case 1
            ...
            Select Case frmPanel.chkActiver
                Case 0
                    ...
                    frmPanel.chkActiver.Caption = "DÈgrader"
        ...
        Case 2
            ...
            frmPanel.optAffichage(DÈfinitionPoint - 1) = True
            frmPanel.optAffichage(0).Visible = True
            frmPanel.optAffichage(1).Visible = True
            frmPanel.optAffichage(2).Visible = True
        ...
        Case 3
            ...
            If gv0010(5, 1) = 0 Then
                ...
                frmPanel.optAffichage(1).Caption = "Moyenne"
                frmPanel.optAffichage(2).Caption = "Basse"
                frmPanel.optAffichage(DÈfinitionQuadrilÈ - 1) = True
                frmPanel.optAffichage(0).Visible = True
                frmPanel.optAffichage(1).Visible = True
                frmPanel.optAffichage(2).Visible = True
            Else
        ...
        Case 4
            ...
            frmPanel.optAffichage(1).Caption = "Moyenne"
            frmPanel.optAffichage(2).Caption = "Basse"
            frmPanel.optAffichage(DÈfinitionMire - 1) = True
            frmPanel.optAffichage(0).Visible = True
            frmPanel.optAffichage(1).Visible = True
            frmPanel.optAffichage(2).Visible = True
            frmPanel.Check1(0).Visible = False
        ...
        Case 8
            ...
            frmPanel.Check1(1).Caption = "Barres de sÈparations"
